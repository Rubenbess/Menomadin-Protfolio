    ...
    <div>
      ...
      {status === 'idle' && (
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3">
            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-colors ${dragOver ? 'bg-primary-100' : 'bg-slate-100'}`}>
              <Upload size={22} className={dragOver ? 'text-primary-500' : 'text-slate-500'} />
            </div>
            <div>
              <p className="text-sm font-semibold text-slate-900">Drop your Trello JSON here, or <span className="text-primary-500">browse</span></p>
      ...
      {status === 'uploading' && (
        <div className="border-2 border-dashed border-primary-200 bg-primary-50/60 rounded-2xl p-10 text-center">
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 bg-primary-100 rounded-2xl flex items-center justify-center">
              <Upload size={22} className="text-primary-500 animate-bounce" />
            </div>
            <div>
              <p className="text-sm font-semibold text-slate-900">Importing {fileName}…</p>
      ...
      {status === 'success' && results && (
        <div className="space-y-4">
          <div className="bg-primary-50 ring-1 ring-violet-200 rounded-2xl p-5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-primary-500 mt-0.5">{fileName}</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
