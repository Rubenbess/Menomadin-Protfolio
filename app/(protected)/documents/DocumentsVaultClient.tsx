...
const CAT_COLORS: Record<DocumentCategory, string> = {
  'Term Sheet':           'bg-primary-100 text-primary-600',
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        />
        {file ? (
          <div className="flex items-center gap-2 px-3 py-2.5 bg-primary-50 border border-violet-200 rounded-xl">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-8 border-2 border-dashed border-slate-200 rounded-xl text-sm text-slate-400 hover:border-primary-200 hover:text-primary-500 transition-colors"
          >
      ...
      <div className="flex flex-wrap items-center gap-2 mb-5">
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500"
          />
          {search && (
        ...
        {uniqueCompanies.length > 0 && (
          <select value={companyFilter} onChange={e => setCompanyFilter(e.target.value)} className="py-1.5 px-3 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/30 cursor-pointer">
