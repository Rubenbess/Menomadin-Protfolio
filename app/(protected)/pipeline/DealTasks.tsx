      ...
      {showCreateForm && (
        <div className="bg-slate-50 rounded-xl p-3 ring-1 ring-slate-200 space-y-2">
          <input
            ...
            className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500"
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 px-3 py-1.5 bg-brand-500 text-white rounded-lg text-xs font-semibold hover:bg-brand-600 disabled:opacity-50 transition-colors"
            >
