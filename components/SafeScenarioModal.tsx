  ...
  return (
    <Modal open={open} onClose={onClose} title="SAFE Scenario & Conversion">
      <div className="space-y-5">
        ...
        {/* Result */}
        {result && (
          <div className="bg-violet-50 rounded-xl p-4 ring-1 ring-violet-200 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <p className="text-[11px] text-violet-600 mt-0.5">{MECH_LABELS[result.mechanism]}</p>
              </div>
              <div>
                <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Our Ownership</p>
                <p className="text-lg font-bold text-violet-700">{fmtPct(result.ownershipPct)}</p>
              </div>
              <div>
