      ...
      <table className="w-full min-w-[900px] text-sm">
        <thead>
          <tr className="border-b border-neutral-200 bg-neutral-50/70">
            ...
            <th className="hidden lg:table-cell text-left px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Entry Stage</th>
            ...
            <th className="hidden xl:table-cell text-right px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Planned Reserves</th>
            <th className="hidden xl:table-cell text-right px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Deployed Reserves</th>
            <th className="hidden md:table-cell text-right px-5 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Initial Investment</th>
          </tr>
        </thead>
        <tbody>
          {companies.map((co) => {
