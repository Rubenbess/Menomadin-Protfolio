...
import { LayoutDashboard, Building2, GitMerge, Upload, FileDown, LogOut, Network, Bell, Wallet, CheckSquare } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/reserves',   label: 'Reserves',     icon: Wallet },
