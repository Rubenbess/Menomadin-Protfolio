      ...
      {filtered.length === 0 ? (
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-card ring-1 ring-black/[0.04] dark:ring-white/[0.05]">
          <EmptyState
            ...
            action={
              hasActiveFilters ? (
                <button onClick={clearAll} className="text-sm text-brand-500 dark:text-brand-300 hover:underline">
                  Clear filters
                </button>
              ) : (
                <Button onClick={() => setShowAdd(true)}>
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                      ...
                      <Link
                        ...
                        className="text-base font-semibold text-slate-900 hover:text-brand-500 transition-colors leading-snug"
                      >
                        {co.name}
                      </Link>
                    </div>
