        ...
        <div className="bg-white rounded-2xl ring-1 ring-black/[0.04] shadow-card p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="000000"
              className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xl font-mono text-center tracking-[0.4em] text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-500 focus:bg-white transition-all"
            />
          </div>
