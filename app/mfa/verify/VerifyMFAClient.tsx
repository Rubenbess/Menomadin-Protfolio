          ...
          <form onSubmit={handleVerify} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="000000"
                className="w-full px-3.5 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xl font-mono text-center tracking-[0.4em] text-slate-900 placeholder:text-slate-300 placeholder:tracking-[0.4em] focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-500 focus:bg-white transition-all"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 bg-violet-600 text-white text-sm font-semibold rounded-xl hover:bg-violet-700 shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
