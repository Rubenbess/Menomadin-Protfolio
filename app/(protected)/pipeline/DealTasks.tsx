  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Related Tasks ({tasks.length})</p>
        <button
      ...
      {showCreateForm && (
        <div className="bg-slate-50 rounded-xl p-3 ring-1 ring-slate-200 space-y-2">
          <input
            ...
            className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-500"
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 px-3 py-1.5 bg-violet-600 text-white rounded-lg text-xs font-semibold hover:bg-violet-700 disabled:opacity-50 transition-colors"
            >
      ...
      {tasks.length === 0 ? (
        <p className="text-xs text-slate-400 text-center py-4">No tasks yet. Create one to get started.</p>
      ) : (
