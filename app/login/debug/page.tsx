      ...
      <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8 max-w-lg w-full space-y-4">
        ...
        <div className="pt-4 border-t border-slate-700">
          ...
          <ol className="text-sm text-slate-400 space-y-1 list-decimal list-inside">
            <li>Go to <a href="https://supabase.com/dashboard" target="_blank" className="text-violet-400 hover:underline">Supabase Dashboard</a></li>
...
NEXT_PUBLIC_SUPABASE_ANON_KEY=...`}
        ...
        <div className="pt-4">
          <a
            href="/login"
            className="block text-center bg-violet-600 hover:bg-violet-700 text-white font-medium py-2 px-4 rounded-lg transition-colors"
          >
            Back to Login
          </a>
        </div>
