        ...
        {[
          ...
          <div
            ...
            className={`bg-white rounded-2xl shadow-card ring-1 ring-black/[0.04] p-4 border-t-2 ${
              accent === 'violet'  ? 'border-t-primary-500'  :
                  ...
                  {company.board_seat ? (
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${
                      company.board_seat === 'Board Seat'
                        ? 'bg-primary-100 text-primary-600 ring-1 ring-violet-200'
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                              ...
                              <div className="flex-1 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-3">
                                {[
                                  ...
                                  <div key={label}>
                                    <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-0.5">{label}</p>
                                    <p className={`text-sm font-medium ${accent ? 'text-orange-600' : highlight ? 'text-primary-600' : 'text-slate-900'}`}>{value}</p>
                                  </div>
                                ))}
                              </div>
                              ...
                              <div className="sm:text-right flex-shrink-0">
                                <div className="flex items-center gap-1 justify-end">
                                  <button
                                    ...
                                    className="opacity-0 group-hover:opacity-100 p-1.5 text-slate-400 hover:text-primary-500 hover:bg-primary-50 rounded-lg transition-all"
                        ...
                        <div key={`round-${round.id}`} className="p-5 sm:p-6">
                          <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                            ...
                            <div className="sm:w-36 flex-shrink-0">
                              ...
                              {instrument && (
                                <span className="mt-1.5 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-primary-50 text-primary-600 ring-1 ring-violet-200">
                                  {instrument}
                                </span>
                              )}
                            </div>
                            ...
                            <div className="flex-1 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-6 gap-y-3">
                              {[
                                ...
                                <div key={label}>
                                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-0.5">{label}</p>
                                  <p className={`text-sm font-medium ${accent ? 'text-emerald-600' : highlight ? 'text-primary-600' : 'text-slate-900'}`}>{value}</p>
                                </div>
                              ))}
                            </div>
                              ...
                              {roundInvs.map(inv => (
                                <div key={inv.id} className="flex items-center justify-between group">
                                  <div className="flex items-center gap-3 text-xs text-slate-500">
                                    ...
                                    <span className="px-2 py-0.5 rounded-full bg-primary-50 text-primary-600 ring-1 ring-violet-200">{inv.instrument}</span>
                ...
                <div className="px-5 pt-4 pb-2">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    {latest.custom_kpis && Object.entries(latest.custom_kpis).map(([k, v]) => (
                      <div key={k} className="bg-primary-50 rounded-xl px-4 py-3 ring-1 ring-primary-100">
                        <p className="text-xs font-semibold text-primary-300 uppercase tracking-wider mb-0.5">{k}</p>
