            ...
            return (
              <Fragment key={co.id}>
                ...
                {isExpanded && timeline.length > 0 && (
                  <tr key={`${co.id}-expanded`} className="border-t border-brand-100">
                                ...
                                return (
                                  <tr key={`inv-${inv.id}`} className="hover:bg-white/60 transition-colors">
                                    <td className="w-8 pl-8">
                                      <span className="w-1 h-1 rounded-full bg-brand-300 block mx-auto" />
                                    </td>
                                    <td className="px-4 py-2 text-slate-500">{fmtDate(inv.date)}</td>
                                    <td className="px-4 py-2">
                                      <span className="px-2 py-0.5 rounded-full bg-brand-50 text-brand-600 ring-1 ring-violet-200 font-medium">
                                        {inv.instrument}
                                      </span>
                                    </td>
