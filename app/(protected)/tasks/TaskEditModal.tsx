        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 dark:focus:border-brand-500 focus:bg-white dark:focus:bg-slate-700 transition-all resize-none"
            />
          </div>
                ...
                teamMembers.map((member) => (
                  <label key={member.id} className="flex items-center gap-2 cursor-pointer hover:bg-white dark:hover:bg-slate-700 p-2 rounded transition-colors">
                    <input
                      ...
                      className="w-4 h-4 rounded border-slate-300 text-brand-500 focus:ring-brand-500 dark:bg-slate-700 dark:border-slate-600 cursor-pointer"
                    />
